...
export function Publications({ publications = [] }: { publications?: PublicationData[] }) {
    ...
    return (
        <Stack gap="xl" justify="center" align="left" pb={100} pr={100}>
            <Text fz="h1" fw="bolder" ta="left">
                Publications
            </Text>
            <Text fz="h3" c="dimmed" ta="left">
                Here you can find a selection of my publications, including papers,
